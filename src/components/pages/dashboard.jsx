...
const Dashboard = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-300 py-12 px-4 sm:px-6 lg:px-8 mt-24"> {/* Increased mt-24 */}
    ...
    return (
        ...
        >
            ...
            <div className="px-6 py-4 bg-gray-50">
                <button className="w-full bg-indigo-500 text-white py-2 px-4 rounded-md hover:bg-indigo-600 transition duration-300 mb-2">
                    Masuk
                </button>
                <Link 
                    to={to} 
